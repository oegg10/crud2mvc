                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="../MntProducto/">Producto</a>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
                <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
                    <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="index.html"><img src="../../public/assets/images/logo-mini.svg" alt="logo" /></a>
            ...
            <div class="main-panel">
                <div class="content-wrapper pb-0">
                    <div class="page-header flex-wrap">
                        <h3 class="mb-0">Producto <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Desde está ventana podrá dar mantenimiento a los productos.</span>
                        </h3>
                    </div>
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 stretch-card grid-margin">
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="productos_data" class="table">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
                                                <th></th>
